...
;MYRVX64I-NEXT:	lw	x12, 52(x2)
;MYRVX64I-NEXT:	lw	x13, 48(x2)
;MYRVX64I-NEXT:	add	x12, x12, x13
;MYRVX64I-NEXT:	sw	x12, 40(x2)
;MYRVX64I-NEXT:	lw	x12, 52(x2)
;MYRVX64I-NEXT:	lw	x13, 48(x2)
;MYRVX64I-NEXT:	sub	x12, x12, x13
;MYRVX64I-NEXT:	sw	x12, 36(x2)
;MYRVX64I-NEXT:	lw	x12, 52(x2)
;MYRVX64I-NEXT:	lw	x13, 48(x2)
;MYRVX64I-NEXT:	mul	x12, x12, x13
;MYRVX64I-NEXT:	sw	x12, 32(x2)
;MYRVX64I-NEXT:	lw	x12, 52(x2)
;MYRVX64I-NEXT:	sll	x12, x12, x10
;MYRVX64I-NEXT:	sw	x12, 28(x2)
;MYRVX64I-NEXT:	lw	x12, 44(x2)
;MYRVX64I-NEXT:	sll	x12, x12, x11
;MYRVX64I-NEXT:	sw	x12, 12(x2)
;MYRVX64I-NEXT:	lw	x12, 52(x2)
...
;MYRVX64I-NEXT:	sw	x10, 20(x2)
;MYRVX64I-NEXT:	lwu	x10, 48(x2)
;MYRVX64I-NEXT:	sll	x10, x11, x10
