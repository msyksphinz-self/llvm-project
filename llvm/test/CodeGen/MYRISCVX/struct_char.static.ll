...
; MYRVX32I_STATIC_MEDLOW-NEXT:	addi	x10, zero, 100
...
; MYRVX64I_STATIC_MEDLOW-NEXT:	lhu	x11, 2(x10)
; MYRVX64I_STATIC_MEDLOW-NEXT:	addi	x12, zero, 16
; MYRVX64I_STATIC_MEDLOW-NEXT:	sll	x11, x11, x12
; MYRVX64I_STATIC_MEDLOW-NEXT:	lhu	x13, 0(x10)
; MYRVX64I_STATIC_MEDLOW-NEXT:	or	x11, x11, x13
; MYRVX64I_STATIC_MEDLOW-NEXT:	lhu	x13, 6(x10)
; MYRVX64I_STATIC_MEDLOW-NEXT:	sll	x12, x13, x12
; MYRVX64I_STATIC_MEDLOW-NEXT:	lhu	x10, 4(x10)
; MYRVX64I_STATIC_MEDLOW-NEXT:	or	x10, x12, x10
; MYRVX64I_STATIC_MEDLOW-NEXT:	addi	x12, zero, 32
; MYRVX64I_STATIC_MEDLOW-NEXT:	sll	x10, x10, x12
...
; MYRVX64I_STATIC_MEDLOW-NEXT:	addi	x11, zero, 100
