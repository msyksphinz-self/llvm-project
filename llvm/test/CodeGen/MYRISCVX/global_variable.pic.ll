...
; MYRVX32I_PIC_MEDLOW-NEXT:	addi	x10, x10, %pcrel_lo(global_val)
...
; MYRVX64I_PIC_MEDLOW-NEXT:	addi	x10, x10, %pcrel_lo(global_val)
...
; MYRVX32I_PIC_MEDANY-NEXT:	addi	x10, x10, %pcrel_lo(global_val)
...
; MYRVX64I_PIC_MEDANY-NEXT:	addi	x10, x10, %pcrel_lo(global_val)
