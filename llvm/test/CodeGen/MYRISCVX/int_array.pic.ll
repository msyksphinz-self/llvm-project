...
; MYRVX32I_PIC_MEDLOW-NEXT:	addi	x10, x10, %pcrel_lo($__const.int_array.array)
...
; MYRVX32I_PIC_MEDLOW-NEXT:	addi	x10, zero, 301
; MYRVX32I_PIC_MEDLOW-NEXT:	sw	x10, 16(x2)
; MYRVX32I_PIC_MEDLOW-NEXT:	addi	x10, zero, 0
; MYRVX32I_PIC_MEDLOW-NEXT:	addi	x2, x2, 24
...
; MYRVX32I_PIC_MEDANY-NEXT:	addi	x10, x10, %pcrel_lo($__const.int_array.array)
...
; MYRVX32I_PIC_MEDANY-NEXT:	addi	x10, zero, 301
; MYRVX32I_PIC_MEDANY-NEXT:	sw	x10, 16(x2)
; MYRVX32I_PIC_MEDANY-NEXT:	addi	x10, zero, 0
; MYRVX32I_PIC_MEDANY-NEXT:	addi	x2, x2, 24
...
; MYRVX64I_PIC_MEDLOW-NEXT:	addi	x10, x10, %pcrel_lo($__const.int_array.array)
; MYRVX64I_PIC_MEDLOW-NEXT:	ld	x10, 0(x10)
; MYRVX64I_PIC_MEDLOW-NEXT:	lwu	x11, 12(x10)
; MYRVX64I_PIC_MEDLOW-NEXT:	addi	x12, zero, 32
; MYRVX64I_PIC_MEDLOW-NEXT:	sll	x11, x11, x12
; MYRVX64I_PIC_MEDLOW-NEXT:	lwu	x13, 8(x10)
; MYRVX64I_PIC_MEDLOW-NEXT:	or	x11, x11, x13
; MYRVX64I_PIC_MEDLOW-NEXT:	sd	x11, 16(x2)
; MYRVX64I_PIC_MEDLOW-NEXT:	lwu	x11, 4(x10)
; MYRVX64I_PIC_MEDLOW-NEXT:	sll	x11, x11, x12
; MYRVX64I_PIC_MEDLOW-NEXT:	lwu	x10, 0(x10)
; MYRVX64I_PIC_MEDLOW-NEXT:	or	x10, x11, x10
...
; MYRVX64I_PIC_MEDLOW-NEXT:	addi	x10, zero, 301
; MYRVX64I_PIC_MEDLOW-NEXT:	sw	x10, 16(x2)
; MYRVX64I_PIC_MEDLOW-NEXT:	addi	x10, zero, 0
; MYRVX64I_PIC_MEDLOW-NEXT:	addi	x2, x2, 24
...
; MYRVX64I_PIC_MEDANY-NEXT:	addi	x10, x10, %pcrel_lo($__const.int_array.array)
; MYRVX64I_PIC_MEDANY-NEXT:	ld	x10, 0(x10)
; MYRVX64I_PIC_MEDANY-NEXT:	lwu	x11, 12(x10)
; MYRVX64I_PIC_MEDANY-NEXT:	addi	x12, zero, 32
; MYRVX64I_PIC_MEDANY-NEXT:	sll	x11, x11, x12
; MYRVX64I_PIC_MEDANY-NEXT:	lwu	x13, 8(x10)
; MYRVX64I_PIC_MEDANY-NEXT:	or	x11, x11, x13
; MYRVX64I_PIC_MEDANY-NEXT:	sd	x11, 16(x2)
; MYRVX64I_PIC_MEDANY-NEXT:	lwu	x11, 4(x10)
; MYRVX64I_PIC_MEDANY-NEXT:	sll	x11, x11, x12
; MYRVX64I_PIC_MEDANY-NEXT:	lwu	x10, 0(x10)
; MYRVX64I_PIC_MEDANY-NEXT:	or	x10, x11, x10
...
; MYRVX64I_PIC_MEDANY-NEXT:	addi	x10, zero, 301
; MYRVX64I_PIC_MEDANY-NEXT:	sw	x10, 16(x2)
; MYRVX64I_PIC_MEDANY-NEXT:	addi	x10, zero, 0
; MYRVX64I_PIC_MEDANY-NEXT:	addi	x2, x2, 24
