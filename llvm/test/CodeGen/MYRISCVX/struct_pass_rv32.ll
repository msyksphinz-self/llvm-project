...
; MYRVX32I_STATIC_MEDANY-NEXT:	addi	x11, zero, 0
...
; MYRVX32I_STATIC_MEDANY-NEXT:	addi	x12, zero, 1
; MYRVX32I_STATIC_MEDANY-NEXT:	addi	x13, zero, 0
...
; MYRVX32I_STATIC_MEDANY-NEXT:	addi	x13, zero, 1
; MYRVX32I_STATIC_MEDANY-NEXT:	addi	x14, zero, 0
...
; MYRVX32I_STATIC_MEDANY-NEXT:	ori	x11, x10, 4
; MYRVX32I_STATIC_MEDANY-NEXT:	addi	x12, zero, 400
; MYRVX32I_STATIC_MEDANY-NEXT:	sw	x12, 0(x11)
; MYRVX32I_STATIC_MEDANY-NEXT:	addi	x11, zero, 0
; MYRVX32I_STATIC_MEDANY-NEXT:	sw	x11, 20(x2)
; MYRVX32I_STATIC_MEDANY-NEXT:	addi	x11, zero, 900
; MYRVX32I_STATIC_MEDANY-NEXT:	sw	x11, 36(x2)
; MYRVX32I_STATIC_MEDANY-NEXT:	addi	x11, zero, 800
; MYRVX32I_STATIC_MEDANY-NEXT:	sw	x11, 32(x2)
; MYRVX32I_STATIC_MEDANY-NEXT:	addi	x11, zero, 700
; MYRVX32I_STATIC_MEDANY-NEXT:	sw	x11, 28(x2)
; MYRVX32I_STATIC_MEDANY-NEXT:	addi	x11, zero, 600
